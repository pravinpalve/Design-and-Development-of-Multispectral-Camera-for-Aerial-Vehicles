...
image_dir_lens1 = '/Users/gokulmnambiar/Desktop/GitHubRepos/Design-and-Development-of-Multispectral-Camera-for-Aerial-Vehicles/Camera_callibration/checkerboard_Images/Cam0'
image_dir_lens2 = '/Users/gokulmnambiar/Desktop/GitHubRepos/Design-and-Development-of-Multispectral-Camera-for-Aerial-Vehicles/Camera_callibration/checkerboard_Images/Cam1'
image_dir_lens3 = '/Users/gokulmnambiar/Desktop/GitHubRepos/Design-and-Development-of-Multispectral-Camera-for-Aerial-Vehicles/Camera_callibration/checkerboard_Images/Cam2'
image_dir_lens4 = '/Users/gokulmnambiar/Desktop/GitHubRepos/Design-and-Development-of-Multispectral-Camera-for-Aerial-Vehicles/Camera_callibration/checkerboard_Images/Cam3'
...
for fname1, fname2, fname3, fname4 in zip(images_lens1, images_lens2, images_lens3, images_lens4):
    ...
    if ret1 and ret2 and ret3 and ret4:
        ...
        cv2.imshow('img', img2)
        cv2.waitKey(1000)
        cv2.drawChessboardCorners(img3, chessboardSize, corners3, ret3)
        cv2.imshow('img', img3)
        cv2.waitKey(1000)
        cv2.drawChessboardCorners(img4, chessboardSize, corners4, ret4)
        cv2.imshow('img', img4)
        cv2.waitKey(1000)
...
undistorted_image_dir = '/Users/gokulmnambiar/Desktop/GitHubRepos/Design-and-Development-of-Multispectral-Camera-for-Aerial-Vehicles/Camera_callibration/callibrated_images'
